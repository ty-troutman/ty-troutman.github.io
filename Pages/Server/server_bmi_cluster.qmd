...
::: callout-note
We have wrapper scripts to automate assembly of .bat files and submission to the LSF scheduler. More information is available [here](../Analysis/analysis_rna_seq.qmd).
:::
