...
#BSUB -n 24
#BSUB -M 40000
#BSUB -e ./bsub_scripts/Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC.err
#BSUB -o ./bsub_scripts/Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC.out
...
STAR \
    ...
    --readFilesIn /data/hpc-troutman/data/archive/22-06-08_CCHMC_DNASeqCore_SP1//Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC_R1.fastq.gz /data/hpc-troutman/data/archive/22-06-08_CCHMC_DNASeqCore_SP1//Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC_R2.fastq.gz \
    --outFileNamePrefix ./star_out/Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC.mm10. \
    --outSAMtype BAM SortedByCoordinate

# remove STAR temporary directories
rm -r ./star_out/Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC.mm10._STARtmp

# execute HOMER makeTagDirectory
makeTagDirectory ./tag_directories/Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC.mm10/ \
    ./star_out/Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC.mm10.Aligned*am \
    -genome mm10 -checkGC -format sam -sspe -flip

# copy STAR log files to the HOMER tag directory
cp ./star_out/Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC.*Log.final.out ./tag_directories/Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC.star.log.final.mm10/
cp ./star_out/Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC.*Log.out ./tag_directories/Mouse-CB6F1J-Ly6CHiRM-RNA-CDAHFD-4Wk-TGCCGTAA-GTGCATCC.star.log.out.mm10/ \
