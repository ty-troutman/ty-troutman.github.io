...
-   Read! This includes equipment manuals.
...
# Good practice for laboratory notebooks {#lab-notebook}
...
You will need a IS4R HPC account to access the lab’s server drives.
...
**These strategies save time!** Do not use spaces or other special characters in the names:
...
``` bash
    ...
    230601_useridA23_yfcre-yfgflox-goal1
    230601_useridB_diseasetimecourse_yfcre-yfgflox
```
...
``` bash
    ...
    readme
    230601_useridA_yfg_gel.png
    230601_useridB_serum_elisa_il6.csv
```
...
``` bash
    ...
    230601_m2301_male_celltype_markers_8wk_diseasemodel_drug1regimen2
```
:::