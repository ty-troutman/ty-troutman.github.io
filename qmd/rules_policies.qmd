...
# CCHMC and Division Rules

::: callout-important
## These general rules are required

-   All safety guidelines must be consistently followed.
-   Behavior must comply with current CCHMC and divisional requirements.
-   Experiments must be performed in accordance with current operation protocols (IBC, IACUC, IRB, etc).
-   Lab notebooks and records must be accurate and up to date. Lab notebooks belong to CCHMC and the lab. They cannot be taken home.
-   Be a good steward of CCHMC/division/lab resources. Report faulty equipment/reagents.
-   Work hard and work smart. Learn from your mistakes and the mistakes of others.
-   Be willing to receive, give, and act on constructive feedback.
-   Always strive to do rigorous and reproducible science.
:::

# Lab policies

The below policies can be flexible with implementation if in keeping with federal, CCHMC, and lab regulations.

-   Be careful with equipment and reagents.
-   Handle reagents consistent with their intended use.
-   Control for and eliminate sources of cross contamination.
-   Appropriately report faulty reagents/equipment.
-   Maintain **appropriate** inventory levels. Don't be the reason someone's experiment fails.
-   Electronic data should be logically organized and traceable through the lab notebook.
-   Be prepared for lab meetings and journal clubs.

# Lab expectations

## Expectations for everyone

-   Replace reagents and materials ***before*** running out.
-   Clean up after yourself. Dispose of hazardous wastes in a timely manner, and in accordance with CCHMC and Division policies.
-   Mistake will happen. Learn from them. Try to learn from the mistake of colleagues as well.
...
-   Help keep operation protocols (IBC, IACUC, IRB) up to date.
-   Ensure experiment protocols are organized and accessible.

## Expectations for graduate students and research associates
...
::: callout-note
## Most of this information was sourced nearly verbatim from:

[Making the Right Moves: A Practical Guide to Scientifıc Management for Postdocs and New Faculty. Second Edition.](https://www.hhmi.org/sites/default/files/2023-10/making-the-right-moves-second-edition.pdf)
:::
...
-   Visit this site <https://mynotebook.labarchives.com/login> to sign up for a new LabArchives account.
    If you are working at a CCHMC campus, you will be redirected to the Cincinnati Children’s Hospital Medical Center login page.
    If you are working off campus, select the option to ‘create a new account’ and then ‘sign up through your institution’.
    Be sure to sign up using your CCHMC email address so that you are included in our enterprise license and you can take advantage of unlimited data storage!
...
The options are your synchronized OneDrive or one of the lab’s server drives.
