---
title: "Children's Hospital High Performance Computing Cluster"
format:
  html:
    toc: true
    toc-expand: 3
...
Connect to the CCHMC cluster by following IS4R's instructions [here](https://hpc.research.cchmc.org/accessing-the-cluster) and [here](https://hpc.research.cchmc.org/node/26), or follow the examples below.
...
Here is a boilerplate request for a IS4R HPC cluster account that you can update with your own information:
...
May I please have an HPC cluster account? My username is usr0xy (replace with
